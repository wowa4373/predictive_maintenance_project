...
Подробное описание датасета можно найти в [документации](https://archive.ics.uci.edu/dataset/601/predictive+maintenance+data).  (Укажите ссылку на документацию, если она есть).
